-- Closes the demo cycle for HYLA leads: adds a "thinking" outcome and a
-- next_contact_at reminder date, so a lead can never silently get stuck on
-- "demo_scheduled" forever after the demo actually happens.
